<script lang="ts">
	...
	let { items, variant = 'top', accent = 'forest', slug = 'explainer' }: Props = $props();
	...
	{#if variant === 'top'}
		<section class="bg-cream py-8 text-ink md:py-10" aria-labelledby={titleId}>
			<div class="mx-auto max-w-(--container-wide) px-6 lg:px-8">
				...
				>
					<div>
						<p class="text-xs font-bold tracking-[0.22em] text-ink/40 uppercase">Key takeaways</p>
